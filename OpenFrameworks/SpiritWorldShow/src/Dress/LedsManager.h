...
public:
    ...
    typedef vector< LedVector > LedVectors;
...
public:
    ...
    const LedVectors& getLeds() const {return m_leds;}
    ...
    void addLed(const ofPoint&  position,  int index);
    
    void deleteLastLed(int index);
...
private:
    ...
    void createLed(const ofPoint& position, int index);
